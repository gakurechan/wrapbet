  ...
  async function fetchBots() {
    try {
      const res = await authedAPI(
        "/trading/items/bots?game=dahood",
        "GET",
        null,
        true
      );
  ...
  return (
    <>
      <div class="modal" onClick={() => close()}>
        <div class="dahood-container" onClick={(e) => e.stopPropagation()}>
          {(botGroup) => (
            <div class="bot-group" key={botGroup}>
              <For
                each={bots()}
                fallback={<p class="white">No bots available.</p>}
              >
                {(bot) => (
                  <div class="bot-card" key={bot.botId}>
                    ...
                    <div class="bot-details">
                      ...
                      <button class="button-blue join">
                        <a href={bot.privateServerUrl} target="_blank">
                          Join server
                        </a>
                      </button>
                    </div>
          ...
          <p class="notice-text">All DAHOOD bots are located next to DA Bank</p>
