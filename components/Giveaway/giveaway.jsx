...
function Inventory(props) {
	...
	const [baseRate, setBaseRate] = createSignal(2.1);
	...
	function createTrail() {
		...
		slider.style.background =
			"linear-gradient(to right, #FCA31E 0%, #FCA31E " +
			value +
			"%, rgba(252, 163, 30, 0.26) " +
			value +
			"%, rgba(252, 163, 30, 0.26) 100%)";
		resizeInput();
	}
    ...
    const isLoading = () => items.loading || items() === null || !items() || !items
			...
			<div class="modal fadein" onClick={() => props.close()}>
				<div class="coinflip-create" onClick={(e) => e.stopPropagation()}>
					<div class="header">
						...
						<p class="title">
							<img src="/assets/icons/giveawayicon.svg" height="25" alt=""/>
							Create Giveaway
						</p>
					</div>
					...
					<div class="footer">
						<div class="selected info">
							<p style="white-space: nowrap;">
								SELECTED {selectedCount(selectedItems())}/1
							</p>
						</div>

						<button
							class="button-blue join"
							onClick={async () => {
								...
								if (res.message) {
									createNotification('success', 'Successfully created a giveaway.', '');
									props?.close();
								}
							}}
						>
